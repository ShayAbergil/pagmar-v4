...
const default_dq = [
  {
    dq_text_m: "האם שינית משהו בקיום המצווה הזו? אם כן, מה השינוי ומה גרם לך לעשות אותו?",
    dq_text_f: "האם שינית משהו בקיום המצווה הזו? אם כן, מה השינוי ומה גרם לך לעשות אותו?",
    dq_desc: "",
    dq_type: "textarea",
  },
  {
