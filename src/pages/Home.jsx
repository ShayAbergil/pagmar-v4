...
function Home() {
  ...
  return (
    ...
    <br></br>
      ...
      <h3> אמ;לק לסרטון:</h3> */}
      <p>
    אני שי אברג'ל,  סטודנט לתואר שני בעיצוב ב-HIT. <br />
    ...
    <img src={images.t_dark_green} className="inline-icon" /> חלק שלישי - נצלול לשאלות ממוקדות יותר לפי נושא שתבחרו<br></br><br></br>

אשמח לשמוע מכן ומכם – 
 על רגעים שבהם התלבטתם איך לשמור מצווה, 
 ניסיתם להתאים הרגלים דתיים לאורח החיים הנוכחי שלכם, 
 או ארגנתן מחדש מחשבות על דברים שלמדתן בעבר.
 <br></br>
 השאלות סובייקטיביות ולעיתים ניתן לפרש אותן ליותר מכיוון אחד, לכן
אין תשובה "נכונה" או "לא נכונה". הרגישו בנוח לענות על השאלות כפי שאתם מבינים אותן. 
<br></br>
אני מזמין אתכם לפרט, לספר, ולחפור כמה שמרגיש לכם..<br></br><br></br>
...
<img src={images.t_mosaic} className="inline-icon-mosiac" /> אם תרצו, בסוף הסקר תוכלו להשאיר פרטים כדי לקבל עדכונים על תוצאות הסקר.<br></br>
  </p>
